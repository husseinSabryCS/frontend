...
export default function New() {
  ...
  async function joinRequest(formData) {
    // الكود الحالي
    try {
      ...
      console.log("خطأ في العملية", err.response?.data?.message || "حدث خطأ غير متوقع");
      setErrMsg(err.response?.data?.message || "حدث خطأ غير متوقع");
    }
              ...
              <div className="row ">
                ...
                <div className="col">
                  ...
                  <select
                    ...
                    name="level"
                    onChange={handleChange}
                    defaultValue={formData.level} // تحديد القيمة المختارة باستخدام defaultValue
                  >

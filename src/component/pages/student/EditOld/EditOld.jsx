...
export default function New() {
  ...
  async function fetchData() {
    try {
      ...
      const formattedDateOfBirth = studentData.date_of_birth ? new Date(studentData.date_of_birth).toISOString().split('T')[0] : '';

      setFormData(prevData => ({
        ...prevData,
        name: studentData.name,
        email: studentData.email,
        dormTypeWithoutFood: studentData.dormTypeWithoutFood,
  ...
  return (
    <Fragment>
      <form action="/submit" method='post'>
        ...
        {formikObj.errors.name && <div className="alert alert-danger">{formikObj.errors.name}</div>}
          ...
          <div className="row">
            ...
            <Fragment>
              ...
              <div className="row ">
                ...
                <div className="col">
                  <label htmlFor="level" className="mt-3">الفرقه</label>
                  <select
                    id="level"
                    className="form-control w-75"
                    name="level"
                    value={formData.level} // تحديد القيمة المختارة باستخدام value
                    onChange={handleChange}
                  >
